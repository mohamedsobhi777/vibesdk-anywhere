export function SuperVibeLogo(props: React.SVGProps<SVGSVGElement>) {
	return (
		<svg
		...
		>
			...
			{/* soundwave "vibe" mark, centered on y=16 */}
			<rect x="8" y="13" width="2.8" height="6" rx="1.4" fill="#fff" />
			<rect x="12.9" y="9" width="2.8" height="14" rx="1.4" fill="#fff" />
			<rect x="17.8" y="6" width="2.8" height="20" rx="1.4" fill="#fff" />
			<rect x="22.7" y="11" width="2.8" height="10" rx="1.4" fill="#fff" />
		</svg>
	);
}
