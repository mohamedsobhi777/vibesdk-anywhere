...
monaco.editor.defineTheme('supervibe-dark', {
	...
	colors: {
		...
		'editorCursor.foreground': '#b2fab4',
...
monaco.editor.defineTheme('supervibe', {
	...
	rules: [
		...
		{ token: 'class', foreground: '15803d' },
		{ token: 'interface', foreground: '15803d' },
		{ token: 'function', foreground: '953800' },
		{ token: 'member', foreground: '0550ae' },
		{ token: 'variable', foreground: '24292f' },
		{ token: 'constant', foreground: '0550ae' },
		{ token: 'operator', foreground: '15803d' },
		{ token: 'namespace', foreground: '15803d' },
		{ token: 'predefined', foreground: '15803d' },
	...
	colors: {
		...
		'editor.selectionBackground': '#15803d20',
		'editor.inactiveSelectionBackground': '#15803d10',
		'editor.lineHighlightBackground': '#15803d08',
		'editor.wordHighlightBackground': '#15803d15',
		'editor.wordHighlightStrongBackground': '#15803d20',
		'editor.findMatchBackground': '#15803d30',
		'editor.findMatchHighlightBackground': '#15803d15',
	},
});
